...
*   **Image Generation (InvokeAI):**
    *   Generate images from text prompts using a locally hosted InvokeAI server.
*   **Text-to-Speech (TTS):**
...
*   `INVOKEAI_API_URL` (Default: `http://localhost:9090`): Base URL of your InvokeAI server used for the `/invoke` image generation command.
...
*   **`/invoke <prompt> [width] [height] [steps]`**
